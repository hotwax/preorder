...
export default defineComponent({
  ...
  mounted() {
    ...
    let token = this.$route.redirectedFrom?.query.token
     token = CryptoJS.AES.encrypt(token, process.env.VUE_APP_SECURITY_KEY);
    console.log(this.$route.redirectedFrom?.query.token);
