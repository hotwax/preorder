 ...
 * @internal
 */
function generate(targetSource, { type = 'plain', filename = 'vue-i18n-loader.json', inSourceMap = undefined, locale = '', isGlobal = false, sourceMap = false, env = 'development', forceStringify = false }) {
...
function generateNode(generator, node, options) {
            ...
            switch (node.type) {
                case 'Program':
                    if (type === 'plain') {
                        ...
                        generator.indent();
                        generator.pushline(`Component.${variableName} = Component.${variableName} || []`);
