 ...
 * @internal
 */
function generate(targetSource, { type = 'plain', filename = 'vue-i18n-loader.yaml', inSourceMap = undefined, locale = '', isGlobal = false, sourceMap = false, env = 'development', forceStringify = false }) {
