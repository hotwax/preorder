...
const actions: ActionTree<OrderState, RootState> = {
  ...
  updateQuery  ( { commit, dispatch, rootState } , { query }) {
    ...
    const payload = {
      ...
      queryFields: 'parentProductId productId parentProductName productName search_goodIdentifications goodIdentifications orderId search_orderIdentifications customerPartyName',
