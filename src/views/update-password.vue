    ...
    <ion-content :fullscreen="true">
      <div class="flex">
        ...
        <v-form
          ...
          v-slot="{ validate, errors, resetForm, values }"
        >
          ...
          <ion-item lines="none">
            ...
            <ion-toggle
              ...
              name="showPassword"
              color="primary"
              @ionChange="showPassword = !showPassword"
          ...
          <div class="ion-padding">
            <ion-button
              @click="updatePassword(values, resetForm, validate, errors)"
              :disabled="getLength(errors)"
              color="primary"
              fill="outline"
              expand="block"
...
defineRule("required", (value) => {
  return required(value) ? true : (translate("Field is required"));
});
...
defineRule("password", (value) => {
  ...
  return regex.test(String(value))
    ? true
    : (translate("Password must contain at least 8 characters including one digit and one special character"));
});

// TODO check why this doesn't works when the confirm value changes
defineRule("confirmed", (value, params) => {
  return confirmed(value, params) ? true : (translate("Password must match"));
}); 
